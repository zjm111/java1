...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            $.ajax({
                type: "GET",
                url: "${pageContext.request.contextPath}/pro/projectList",
                success: function (msg) {
                    $(msg).each(function (index, itme) {
                        $("#proFk").append("<option value='" + itme.pid + "'>" + itme.pname + "</option>")
                    })
                }
            });
        })
...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/attachment/info" method="post" enctype="multipart/form-data">
