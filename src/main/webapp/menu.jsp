...
<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
    <tr>
        <td style='padding-left:3px;padding-top:8px' valign='top' id="menuss">
            <%-- <c:forEach items="${sessionScope.sourcesList}" var="title" varStatus="index">
                <dl class='bitem'>
                    <dt onclick=showHide("items${index.count}_1")><b>${title.name}</b></dt>
                    <dd style='display:block' class='sitem' id=items${index.count}_1>
                        <ul class='sitemu' id=${index.index}>
                            <c:forEach items="${title.children}" var="Subtitle">
                             <li><a href='/pms/${Subtitle.url}' target='main'>${Subtitle.name}</a></li>
                            </c:forEach>
                        </ul>
                    </dd>
                </dl>
         ...
         <dl class='bitem'>
            ...
            <li><a href='${pageContext.request.contextPath}/pro/PList' target='main'>基本信息管理</a></li>
            <li><a href='${pageContext.request.contextPath}/analyse/anlist' target='main'>需求分析管理</a></li>
            ...
            <li><a href='${pageContext.request.contextPath}/mf/mfmi' target='main'>我的档案</a></li>
