...
<script type="text/javascript">
    $(function(){
        ...
        $.ajax({
            type: "GET",
            url: "${pageContext.request.contextPath}/cus/showDetail/"+id,
            success: function(msg){
              	$("#cid").val(id);
                $("#comname").val(msg.comname);
                $("#companyperson").val(msg.companyperson)
                $("#comaddress").val(msg.comaddress)
                $("#comphone").val(msg.comphone)
                $("#camera").val(msg.camera)
                $("#present").text(msg.present)
...
<form id="form2" name="form2" action="${pageContext.request.contextPath}/cus/updatecus" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="comname" id="comname" value=""/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">公司联系人：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="companyperson" id="companyperson" value=""/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">公司地址：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="comaddress" id="comaddress" size="60" value=""/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">联系电话：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="comphone" id="comphone" value=""/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">座机：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input name="camera" id="camera" value=""/></td>
</tr>
<tr >
