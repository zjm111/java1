    ...
    <script type="text/javascript">
        ...
        function commit() {
            ...
            for (var i=0;i<nodes.length;i++){
                sourceIds+=nodes[i].id+",";
            }
            $("#sourceIds").val(sourceIds);
            $("#form2").submit();
...
<form name="form2" action="${pageContext.request.contextPath}/role/saveInfo" id="form2" method="post">
    <input type="hidden" id="sourceIds" name="sourceIds">
