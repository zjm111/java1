  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：${sessionScope.activeUser.ename}，欢迎使用项目平台管理系统！
        	
        	
        	[<a href="${pageContext.request.contextPath}/login.jsp" onClick="parent.location.href='login.htm'" target="_login">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
