...
<LINK href="images/newhead.css" type=text/css rel=stylesheet>
	...
	<script type="text/javascript">
        function switchcode(obj){
            obj.src="${pageContext.request.contextPath}/code.jpg";
        }
	</script>
</HEAD>
										...
										<TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16 size=16 value=admin id=username name="username"></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password maxLength=16 size=16 value=123 id=pass name="password"></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>验证码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写验证码 maxLength=50
														size=16 value="" name="code"><span style="color: red;font-size: 15px">${msg}</span><img onclick="switchcode(this)" src="${pageContext.request.contextPath}/code.jpg" alt=""></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
