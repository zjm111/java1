            ...
            $.ajax({
                ...
                success: function (msg) {
                    $(msg).each(function (index, itme) {
                        $("#se").append("<option name='ename' value='" + itme.eid + "'>" + itme.ename + "</option>")
                    })
                }
            });
        });
...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/email/emailbc" method="post">
