...
<body>
    <form name="" action="${pageContext.request.contextPath}/tz/seaveInfo" method="post">
         标题：<input type="text" name="biaoti">
        <script id="editor" name="neirong" type="text/plain" style="width:1024px;height:500px;"></script>
